...
# Date: Fri, 21 Jul 2023 04:28:21 GMT
#set_units -time ns
...
create_generated_clock -name {ADC_SAR_1_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 5 11} [list [get_pins {ClockBlock/aclk_glb_0}]]
