...
/* ADC_Input */
#define ADC_Input__0__INTTYPE CYREG_PICU1_INTTYPE6
#define ADC_Input__0__MASK 0x40u
#define ADC_Input__0__PC CYREG_PRT1_PC6
#define ADC_Input__0__PORT 1u
#define ADC_Input__0__SHIFT 6u
#define ADC_Input__AG CYREG_PRT1_AG
#define ADC_Input__AMUX CYREG_PRT1_AMUX
#define ADC_Input__BIE CYREG_PRT1_BIE
#define ADC_Input__BIT_MASK CYREG_PRT1_BIT_MASK
#define ADC_Input__BYP CYREG_PRT1_BYP
#define ADC_Input__CTL CYREG_PRT1_CTL
#define ADC_Input__DM0 CYREG_PRT1_DM0
#define ADC_Input__DM1 CYREG_PRT1_DM1
#define ADC_Input__DM2 CYREG_PRT1_DM2
#define ADC_Input__DR CYREG_PRT1_DR
#define ADC_Input__INP_DIS CYREG_PRT1_INP_DIS
#define ADC_Input__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define ADC_Input__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define ADC_Input__LCD_EN CYREG_PRT1_LCD_EN
#define ADC_Input__MASK 0x40u
#define ADC_Input__PORT 1u
#define ADC_Input__PRT CYREG_PRT1_PRT
#define ADC_Input__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define ADC_Input__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define ADC_Input__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define ADC_Input__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define ADC_Input__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define ADC_Input__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define ADC_Input__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define ADC_Input__PS CYREG_PRT1_PS
#define ADC_Input__SHIFT 6u
#define ADC_Input__SLW CYREG_PRT1_SLW
...
/* DAC_Output */
#define DAC_Output__0__INTTYPE CYREG_PICU1_INTTYPE7
#define DAC_Output__0__MASK 0x80u
#define DAC_Output__0__PC CYREG_PRT1_PC7
#define DAC_Output__0__PORT 1u
#define DAC_Output__0__SHIFT 7u
#define DAC_Output__AG CYREG_PRT1_AG
#define DAC_Output__AMUX CYREG_PRT1_AMUX
#define DAC_Output__BIE CYREG_PRT1_BIE
#define DAC_Output__BIT_MASK CYREG_PRT1_BIT_MASK
#define DAC_Output__BYP CYREG_PRT1_BYP
#define DAC_Output__CTL CYREG_PRT1_CTL
#define DAC_Output__DM0 CYREG_PRT1_DM0
#define DAC_Output__DM1 CYREG_PRT1_DM1
#define DAC_Output__DM2 CYREG_PRT1_DM2
#define DAC_Output__DR CYREG_PRT1_DR
#define DAC_Output__INP_DIS CYREG_PRT1_INP_DIS
#define DAC_Output__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define DAC_Output__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define DAC_Output__LCD_EN CYREG_PRT1_LCD_EN
#define DAC_Output__MASK 0x80u
#define DAC_Output__PORT 1u
#define DAC_Output__PRT CYREG_PRT1_PRT
#define DAC_Output__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define DAC_Output__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define DAC_Output__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define DAC_Output__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define DAC_Output__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define DAC_Output__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define DAC_Output__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define DAC_Output__PS CYREG_PRT1_PS
#define DAC_Output__SHIFT 7u
#define DAC_Output__SLW CYREG_PRT1_SLW
...
#define ADC_Finished_Interrupt__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define ADC_Finished_Interrupt__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define ADC_Finished_Interrupt__INTC_MASK 0x01u
#define ADC_Finished_Interrupt__INTC_NUMBER 0u
#define ADC_Finished_Interrupt__INTC_PRIOR_NUM 7u
#define ADC_Finished_Interrupt__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define ADC_Finished_Interrupt__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define ADC_Finished_Interrupt__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
